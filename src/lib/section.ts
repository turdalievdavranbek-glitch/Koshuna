...
export function patchForSection(id: SectionId, prev: Filters): Partial<Filters> {
  ...
  return {
    ...
    realtyGroup: id === "rent" ? prev.realtyGroup : "any",
    realtySub: id === "rent" ? prev.realtySub : "any",
    realtyKind: id === "rent" ? prev.realtyKind : "any",
    areaMin: id === "rent" ? prev.areaMin : null,
    areaMax: id === "rent" ? prev.areaMax : null,
