...
const KIND_RULES: { id: MenuKind; keys: string[] }[] = [
  ...
  { id: "main-meat", keys: ["бешбармак", "манты", "лагман", "казы"] },
  { id: "grill-shashlyk", keys: ["шашлык", "шашлыч"] },
  { id: "grill-meat", keys: ["на углях", "мангал", "ребра гриль"] },
  { id: "grill-sides", keys: ["картофель по-деревен", "лаваш к шашл"] },
  ...
  { id: "drink-hot", keys: ["чай"] },
  { id: "drink-cold", keys: ["компот", "лимонад"] },
  { id: "drink-fresh", keys: ["фреш", "свежевыжат", "сок апельсин"] },
  { id: "drink-ayran", keys: ["айран", "тан "] },
  { id: "coffee-drink", keys: ["кофе", "американо", "капучино", "латте"] },
  { id: "coffee-dessert", keys: ["чизкейк", "круассан"] },
  ...
  { id: "bf-pastry", keys: ["блин", "сырник"] },
  { id: "lunch-set", keys: ["бизнес-ланч", "комплексный обед"] },
  { id: "lunch-combo", keys: ["комбо", "набор "] },
];
